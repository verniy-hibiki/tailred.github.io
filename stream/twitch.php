...
<body>
	<object type="application/x-shockwave-flash" width="798" height="483" data="http://www.twitch.tv/widgets/live_embed_player.swf?channel=albrecht84">
		<param name="flashvars" value="channel=albrecht84&auto_play=true">
		<param name="movie" value="http://www.twitch.tv/widgets/live_embed_player.swf">
		<param name="allowFullScreen" value="true">
		<param name="allowscriptaccess" value="always">
	</object>
	<iframe src="http://www.twitch.tv/chat/embed?channel=albrecht84&popout_chat=true" width="310" height="477" scrolling="no"></iframe>
	...
	<script>
		function info(){
			...
			var h=document.head;
			s.src="http://api.justin.tv/api/stream/list.json?jsonp=jsonp&channel=albrecht84";
